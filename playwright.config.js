  ...
  projects: [
    {
      ...
      use: {
        ...
        env: {
          TEST_USERNAME: process.env.CHROMIUM_USER,
          TEST_PASSWORD: process.env.CHROMIUM_PASS,
        },
      },
    },

    {
      ...
      use: {
        ...
        env: {
          TEST_USERNAME: process.env.FIREFOX_USER,
          TEST_PASSWORD: process.env.FIREFOX_PASS,
        },
      },
    },
